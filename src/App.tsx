        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <nav className="flex bg-slate-800 rounded-2xl p-1 shadow-inner" id="main-tabs-navigation">
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 focus:outline-none ${
      ...
      <div className="bg-emerald-50 border-b border-emerald-100 py-3 px-6 text-emerald-950 shadow-sm" id="invite-bar">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <button
            ...
            className={`py-1.5 px-4 rounded-xl text-xs font-extrabold flex items-center gap-1.5 transition-all focus:outline-none ${
              shareSuccess 
                ...
                <div className="flex bg-white rounded-2xl p-1.5 shadow-sm border border-slate-200/50 max-w-sm">
                  <button
                    ...
                    className={`flex-1 py-2 text-center text-xs font-bold rounded-xl transition-all ${
                      quinielaSubView === 'group' ? 'bg-slate-950 text-white' : 'text-slate-500 hover:text-slate-800'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex-1 py-2 text-center text-xs font-bold rounded-xl transition-all ${
                      quinielaSubView === 'bracket' ? 'bg-slate-950 text-white' : 'text-slate-500 hover:text-slate-800'
                    }`}
                  >
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                      ...
                      <div className="flex bg-slate-250 bg-slate-200/50 rounded-2xl p-1 max-w-xs border border-slate-300/30">
                        <button
                          type="button"
                          onClick={() => setQuinielaSubView('group')}
                          className={`flex-1 py-2.5 px-4 text-center text-xs font-extrabold rounded-xl transition-all focus:outline-none ${
                            quinielaSubView === 'group' 
